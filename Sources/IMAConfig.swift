...
@objc public class IMAConfig: NSObject {
    ...
    @objc public var companionView: UIView? // CompanionView is not available on tvOS, it will be ignored.
    ...
    @discardableResult
    @nonobjc public func set(adsResponse: String) -> Self {
    ...
    @discardableResult
    @nonobjc public func set(maxRedirects: UInt) -> Self {
